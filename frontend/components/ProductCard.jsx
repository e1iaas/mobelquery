// ProductCard.jsx
export default function ProductCard({ title, image, url, available, price, currency }) {
  return (
    <div className="bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        {/* Title */}
        <a href={url}>
          <h3 className="text-sm font-medium text-gray-800 hover:text-green-800 line-clamp-3 mb-3 leading-snug">
            {title}
          </h3>
        </a>
